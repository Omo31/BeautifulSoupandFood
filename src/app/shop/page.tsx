...
const allProducts = [
  ...
  { id: "5", name: "Fresh Berry Medley", price: 12.00, stock: 0, image: PlaceHolderImages.find(img => img.id === 'product-5')! },
  { id: "6", name: "Vintage Red Wine", price: 45.00, stock: 8, image: PlaceHolderImages.find(img => img.id === 'product-6')! },
];
